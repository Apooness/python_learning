...
# Form implementation generated from reading ui file 'tableViewdesign.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(969, 797)
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.tableProducts = QtWidgets.QTableWidget(self.centralwidget)
        self.tableProducts.setGeometry(QtCore.QRect(50, 50, 441, 391))
        ...
        self.widget.setGeometry(QtCore.QRect(570, 50, 321, 151))
